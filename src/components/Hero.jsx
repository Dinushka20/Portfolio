...
const Hero = () => {
    ...
    return (
        <section className="relative min-h-screen flex" id="hero">
            ...
            <div className="max-w-[95rem] mx-auto w-full flex flex-col relative z-20 px-6 md:px-12 pt-28 lg:pt-[15vh] pb-24 min-h-[100svh]">
                ...
                <div className="relative z-30 flex flex-col justify-center flex-grow w-full lg:w-[65%] xl:w-[60%]">
                    <div className="space-y-5 lg:space-y-6">
                        ...
                        >
                            <Link to="/contact" className="group relative bg-[#81ecff] text-[#003840] font-bold py-4 px-9 rounded-xl flex items-center gap-3 hover:shadow-[0_0_30px_rgba(129,236,255,0.4)] transition-all active:scale-95 text-base lg:text-lg overflow-hidden">
                ...
                {/* Mobile-only Profile Photo - Removed from stack to prevent overflow */}
            </div>

            {/* Mobile-only Profile Photo - Absolute positioned to stay within viewport and blend beautifully */}
            <div className="absolute inset-x-0 bottom-0 flex lg:hidden h-[75vh] sm:h-[80vh] justify-center items-end opacity-85 pointer-events-none z-0 overflow-hidden"
                ...
                {/* Glow effect behind mobile image */}
                <div className="absolute bottom-[5%] w-[80vw] h-[80vw] bg-[#81ecff]/20 blur-[90px] rounded-full"></div>
                <div className="absolute bottom-[-10%] w-[60vw] h-[60vw] bg-[#e966ff]/15 blur-[80px] rounded-full"></div>

                <motion.div
                    initial={{ opacity: 0, y: 50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.2, duration: 1.2, ease: [0.22, 1, 0.36, 1] }}
                    className="relative w-full max-w-[600px] h-full flex justify-center items-end origin-bottom"
                >
                    <motion.div
                        animate={{ y: [0, -8, 0] }}
                    ...
                    >
                        <img
                            ...
                            className="w-full h-full object-contain object-bottom relative z-10 origin-bottom grayscale-[15%] brightness-[1.1] contrast-[1.2]"
                            style={{ filter: 'drop-shadow(0px -10px 40px rgba(129,236,255,0.3))' }}
                        />
                    </motion.div>
                </motion.div>
            </div>
            ...
            <div className="absolute inset-y-0 right-0 hidden lg:flex lg:w-[50vw] xl:w-[45vw] z-10 pointer-events-none justify-end items-end overflow-visible opacity-90">
                {/* Glow effect behind desktop image */}
                <div className="absolute bottom-[10%] right-[15%] w-[35vw] h-[35vw] bg-[#81ecff]/15 blur-[120px] rounded-full"></div>
                <div className="absolute top-[30%] right-[5%] w-[25vw] h-[25vw] bg-[#e966ff]/10 blur-[100px] rounded-full"></div>
                ...
                >
                    <motion.div
                        ...
                        style={{
                            maskImage: 'linear-gradient(to right, transparent 0%, black 15%, black 100%), linear-gradient(to bottom, transparent 0%, black 15%, black 100%)',
                            maskComposite: 'intersect',
                            WebkitMaskImage: 'linear-gradient(to right, transparent 0%, black 15%, black 100%), linear-gradient(to bottom, transparent 0%, black 15%, black 100%)',
                            WebkitMaskComposite: 'source-in'
                        }}
                    >
                        ...
                        <img
                            src="/profile-nobg best.png"
                            alt="Dinushka Sandeepa"
                            className="w-full h-full object-contain object-right-bottom relative z-10 origin-bottom-right grayscale-[10%] brightness-[1.1] contrast-[1.15]"
                            style={{
                                filter: 'drop-shadow(-10px 10px 60px rgba(129,236,255,0.25))'
                            }}
                        />
                    </motion.div>
                </motion.div>
